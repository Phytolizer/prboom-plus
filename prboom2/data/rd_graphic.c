...
static unsigned char* parseppm(char* ppm, size_t size, const char* file, int* width, int* height) {
...
static void pixels_to_colours(int* colours, unsigned char* pixels, int width, int height, int x) {
	int i = height;
	int* colour = colours;
...
size_t ppm_to_patch(void** lumpdata, const char* filename, int insert_x, int insert_y) {
	void* data;
