...
default_t defaults[] = {
		...
		{"demo_insurance", {&default_demo_insurance}, {2}, 0, 2, // killough 3/31/98
				def_int,
				ss_none}, // 1=take special steps ensuring demo sync, 2=only during recordings
		{"endoom_mode", {&endoom_mode}, {5}, 0, 7, // CPhipps - endoom flags
				def_hex,
				ss_none}, // 0, +1 for colours, +2 for non-ascii chars, +4 for skip-last-line
		...
		{"monster_infighting", {&default_monster_infighting}, {1}, 0, 1, def_bool, ss_enem,
				&monster_infighting},
		{"monster_backing", {&default_monster_backing}, {0}, 0, 1, def_bool, ss_enem,
				&monster_backing},
		...
		{"comp_zombie", {&default_comp[comp_zombie]}, {1}, 0, 1, def_bool, ss_comp,
				&comp[comp_zombie]},
		...
		{"comp_moveblock", {&default_comp[comp_moveblock]}, {0}, 0, 1, def_bool, ss_comp,
				&comp[comp_moveblock]},
		{"comp_sound", {&default_comp[comp_sound]}, {0}, 0, 1, def_bool, ss_comp,
				&comp[comp_sound]},
		...
		{"sound_card", {&snd_card}, {-1}, -1, 7, // jff 1/18/98 allow Allegro drivers
				def_int, ss_none}, // select sounds driver (DOS), -1 is autodetect, 0 is none; in
                                   // Linux, non-zero enables sound
		{"music_card", {&mus_card}, {-1}, -1, 9, //  to be set,  -1 = autodetect
				def_int, ss_none}, // select music driver (DOS), -1 is autodetect, 0 is none"; in
                                   // Linux, non-zero enables music
		{"pitched_sounds", {&pitched_sounds}, {0}, 0, 1, // killough 2/21/98
				def_bool,
				ss_none}, // enables variable pitch in sound effects (from id's original code)
		...
		{"mus_pause_opt", {&mus_pause_opt}, {1}, 0, 2, // CPhipps - music pausing
				def_int,
				ss_none}, // 0 = kill music when paused, 1 = pause music, 2 = let music continue
		{"snd_channels", {&default_numChannels}, {32}, 1, 32, def_int,
		...
		{"snd_soundfont", {NULL, &snd_soundfont}, {0, "/usr/share/sounds/sf3/default-GM.sf3"}, UL,
				UL, def_str, ss_none}, // soundfont name for synths that support it
#endif
		...
		{"lowpass_filter", {&lowpass_filter}, {0}, 0, 1, def_bool,
				ss_none}, // low-pass filter borrowed from Chocolate Doom so upscaling old audio
                          // doesn't sound too horrible
		{"full_sounds", {&full_sounds}, {0}, 0, 1, def_bool, ss_none}, // disable sound cutoffs

#ifdef _WIN32
		{"mus_extend_volume", {&mus_extend_volume}, {0}, 0, 1, def_bool,
				ss_none}, // e6y: apply midi volume to all midi devices
#endif
		...
		{"use_fullscreen", {&use_fullscreen}, {0}, 0, 1, /* proff 21/05/2000 */
				def_bool, ss_none},
		{"exclusive_fullscreen", {&exclusive_fullscreen}, {0}, 0,
				1, // [FG] mode-changing fullscreen
				def_bool, ss_none},
		...
		{"gl_ext_packed_depth_stencil", {&gl_ext_packed_depth_stencil_default}, {1}, 0, 1, def_bool,
				ss_stat},
		{"gl_ext_texture_filter_anisotropic", {&gl_ext_texture_filter_anisotropic_default}, {1}, 0,
				1, def_bool, ss_stat},
		...
		{"gl_texture_filter", {(int*)&gl_texture_filter}, {filter_nearest_mipmap_linear},
				filter_nearest, filter_count - 1, def_int, ss_none},
		{"gl_sprite_filter", {(int*)&gl_sprite_filter}, {filter_nearest}, filter_nearest,
				filter_linear_mipmap_nearest, def_int, ss_none},
		{"gl_patch_filter", {(int*)&gl_patch_filter}, {filter_nearest}, filter_nearest,
				filter_linear, def_int, ss_none},
		...
		{"gl_skymode", {(int*)&gl_skymode}, {skytype_auto}, skytype_auto, skytype_count - 1,
				def_int, ss_none},
		...
		{"key_novert", {&key_novert}, {0}, 0, MAX_KEY, def_key,
				ss_keys},                                        // key to toggle novert mode
		...
		{"key_strafeleft", {&key_strafeleft}, {'a'}, 0, MAX_KEY, def_key,
				ss_keys}, // key to strafe left
		{"key_straferight", {&key_straferight}, {'d'}, 0, MAX_KEY, def_key,
				ss_keys},                                                     // key to fly up
		...
		{"key_use", {&key_use}, {' '}, 0, MAX_KEY, def_key,
				ss_keys}, // key to open a door, use a switch
		...
		{"key_endgame", {&key_endgame}, {KEYD_F7}, 0, MAX_KEY, def_key,
				ss_keys}, // key to end the game
		...
		{"key_pause", {&key_pause}, {KEYD_PAUSE}, 0, MAX_KEY, def_key,
				ss_keys}, // key to pause the game
		{"key_autorun", {&key_autorun}, {KEYD_CAPSLOCK}, 0, MAX_KEY, def_key,
				ss_keys}, // key to toggle always run mode
		{"key_chat", {&key_chat}, {'t'}, 0, MAX_KEY, def_key,
				ss_keys}, // key to enter a chat message
		...
		{"key_reverse", {&key_reverse}, {'/'}, 0, MAX_KEY, def_key,
				ss_keys}, // key to spin 180 instantly
		{"key_zoomin", {&key_zoomin}, {'='}, 0, MAX_KEY, def_key,
				ss_keys}, // key to enlarge display
		{"key_zoomout", {&key_zoomout}, {'-'}, 0, MAX_KEY, def_key,
				ss_keys}, // key to reduce display
		...
		{"map_grid_size", {&map_grid_size}, {128}, 8, 256, def_int, ss_auto},
		{"map_scroll_speed", {&map_scroll_speed}, {8}, 1, 32, def_int, ss_auto},
		...
		{"map_things_appearance", {(int*)&map_things_appearance}, {map_things_appearance_max - 1},
				0, map_things_appearance_max - 1, def_int, ss_auto},
		...
		{"hudcolor_mapstat_time", {&hudcolor_mapstat_time}, {2}, 0, 9, // gray range
				def_int,
				ss_auto}, // color range used for automap statistics for level time and total time
		...
		{"cap_soundcommand", {NULL, &cap_soundcommand},
				{0, "ffmpeg -f s16le -ar %s -ac 2 -i - -c:a libopus -y temp_a.nut"}, UL, UL,
				def_str, ss_none},
		{"cap_videocommand", {NULL, &cap_videocommand},
				{0,
						"ffmpeg -f rawvideo -pix_fmt rgb24 -r %r -s %wx%h -i - -c:v libx264 -y "
                        "temp_v.nut"},
		...
		{"gl_spriteclip", {(int*)&gl_spriteclip}, {spriteclip_smart}, spriteclip_const,
				spriteclip_smart, def_int, ss_none},
		...
		{"gl_texture_hqresize_textures", {&gl_texture_hqresize_textures}, {hq_scale_2x},
				hq_scale_none, hq_scale_max - 1, def_int, ss_stat},
		{"gl_texture_hqresize_sprites", {&gl_texture_hqresize_sprites}, {hq_scale_none},
				hq_scale_none, hq_scale_max - 1, def_int, ss_stat},
		{"gl_texture_hqresize_patches", {&gl_texture_hqresize_patches}, {hq_scale_2x},
				hq_scale_none, hq_scale_max - 1, def_int, ss_stat},
		...
		{"gl_motionblur_min_angle", {NULL, &motion_blur.str_min_angle}, {0, "20.0"}, UL, UL,
				def_str, ss_none},
		{"gl_motionblur_att_a", {NULL, &motion_blur.str_att_a}, {0, "55.0"}, UL, UL, def_str,
				ss_none},
		{"gl_motionblur_att_b", {NULL, &motion_blur.str_att_b}, {0, "1.8"}, UL, UL, def_str,
				ss_none},
		{"gl_motionblur_att_c", {NULL, &motion_blur.str_att_c}, {0, "0.9"}, UL, UL, def_str,
				ss_none},
		...
		{"overrun_spechit_emulate", {&overflows[OVERFLOW_SPECHIT].emulate}, {1}, 0, 1, def_bool,
				ss_stat},
		{"overrun_reject_warn", {&overflows[OVERFLOW_REJECT].warn}, {0}, 0, 1, def_bool, ss_stat},
		{"overrun_reject_emulate", {&overflows[OVERFLOW_REJECT].emulate}, {1}, 0, 1, def_bool,
				ss_stat},
		{"overrun_intercept_warn", {&overflows[OVERFLOW_INTERCEPT].warn}, {0}, 0, 1, def_bool,
				ss_stat},
		...
		{"overrun_donut_emulate", {&overflows[OVERFLOW_DONUT].emulate}, {0}, 0, 1, def_bool,
				ss_stat},
		...
		{"demo_pattern0", {NULL, &demo_patterns_list_def[0]},
				{0, "DOOM 2: Hell on Earth/((lv)|(nm)|(pa)|(ty))\\d\\d.\\d\\d\\d\\.lmp/doom2.wad"},
				UL, UL, def_str, ss_none},
		...
		{"demo_pattern5", {NULL, &demo_patterns_list_def[5]},
				{0,
						"Requiem/r(c|f|n|p|q|r|s|t)\\d\\d.\\d\\d\\d\\.lmp/"
		...
		{"demo_pattern7", {NULL, &demo_patterns_list_def[7]},
				{0, "Memento Mori/mm\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|mm.wad|mmmus.wad"}, UL, UL,
				def_str, ss_none},
		{"demo_pattern8", {NULL, &demo_patterns_list_def[8]},
				{0, "Memento Mori 2/m2\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|mm2.wad|mm2mus.wad"}, UL, UL,
				def_str, ss_none},
