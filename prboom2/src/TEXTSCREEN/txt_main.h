...
#define TXT_KEY_TO_MOUSE_BUTTON(x) \
	((x) >= TXT_MOUSE_BASE && (x) < TXT_MOUSE_BASE + TXT_MAX_MOUSE_BUTTONS ? (x)-TXT_MOUSE_BASE \
																		   : -1)
...
typedef enum { TXT_MOD_SHIFT, TXT_MOD_CTRL, TXT_MOD_ALT, TXT_NUM_MODIFIERS } txt_modifier_t;
