...
#define UKKQUEUE_BACKWARDS_COMPATIBLE \
	1 // 1 to send old-style kqueue:receivedNotification:forFile: messages to objects that accept
	  // them.
#endif
...
+ (UKKQueue*)sharedQueue; // Returns a singleton, a shared kqueue object Handy if you're subscribing
                          // to the notifications. Use this, or just create separate objects using
                          // alloc/init. Whatever floats your boat.
