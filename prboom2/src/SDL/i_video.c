...
#define SCANCODE_TO_KEYS_ARRAY \
	{ \
		0, 0, 0, 0, 'a',                                          /* 0-9 */ \
				...
				'6', '7', '8', '9', '0', KEYD_ENTER, KEYD_ESCAPE, KEYD_BACKSPACE, KEYD_TAB, \
				' ',                                                                /* 40-49 */ \
				KEYD_MINUS, KEYD_EQUALS, '[', ']', '\\', '\\', ';', '\'', '`', ',', /* 50-59 */ \
				'.', '/', KEYD_CAPSLOCK, KEYD_F1, KEYD_F2, KEYD_F3, KEYD_F4, KEYD_F5, KEYD_F6, \
				KEYD_F7, /* 60-69 */ \
				KEYD_F8, KEYD_F9, KEYD_F10, KEYD_F11, KEYD_F12, KEYD_PRINTSC, KEYD_SCROLLLOCK, \
				KEYD_PAUSE, KEYD_INSERT, KEYD_HOME, /* 70-79 */ \
				KEYD_PAGEUP, KEYD_DEL, KEYD_END, KEYD_PAGEDOWN, KEYD_RIGHTARROW, KEYD_LEFTARROW, \
				KEYD_DOWNARROW, KEYD_UPARROW, /* 80-89 */ \
				KEYD_NUMLOCK, KEYD_KEYPADDIVIDE, KEYD_KEYPADMULTIPLY, KEYD_KEYPADMINUS, \
				KEYD_KEYPADPLUS, KEYD_KEYPADENTER, KEYD_KEYPAD1, KEYD_KEYPAD2, KEYD_KEYPAD3, \
				KEYD_KEYPAD4, KEYD_KEYPAD5, KEYD_KEYPAD6, /* 90-99 */ \
				KEYD_KEYPAD7, KEYD_KEYPAD8, KEYD_KEYPAD9, KEYD_KEYPAD0, KEYD_KEYPADPERIOD, 0, 0, \
				0, KEYD_EQUALS /* 100-103 */ \
	}
...
static int cmp_resolutions(const void* a, const void* b) {
	...
	if (sscanf(*sa, "%dx%d", &wa, &ha) != 2)
		wa = ha = 0;
	if (sscanf(*sb, "%dx%d", &wb, &hb) != 2)
		wb = hb = 0;
...
void I_SetWindowIcon(void) {
	...
	if (!surface) {
		surface = SDL_CreateRGBSurfaceFrom(icon_data, icon_w, icon_h, 32, icon_w * 4, 0xff << 0,
...
void I_UpdateVideoMode(void) {
	...
	if (V_GetMode() == VID_MODEGL) {
		...
		if (screen == NULL) {
			I_Error("Couldn't set %dx%d video mode [%s]", SCREENWIDTH, SCREENHEIGHT,
					SDL_GetError());
		}
	}
