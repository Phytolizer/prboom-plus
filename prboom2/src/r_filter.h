...
#define FILTER_GETV(x, y, texV, nextRowTexV) \
	(filter_getDitheredPixelLevel(x, y, (((texV)-yl) >> 8) & 0xff) ? ((nextRowTexV) >> FRACBITS) \
																   : ((texV) >> FRACBITS))
...
#define filter_getDitheredForColumn(x, y, texV, nextRowTexV) \
	dither_sources[(filter_getDitheredPixelLevel(x, y, filter_fracu))] \
...
#define filter_getRoundedForColumn(texV, nextRowTexV) \
	filter_getScale2xQuadColors(source[((texV) >> FRACBITS)], \
			source[(MAX(0, ((texV) >> FRACBITS) - 1))], nextsource[((texV) >> FRACBITS)], \
			source[((nextRowTexV) >> FRACBITS)], prevsource[((texV) >> FRACBITS)]) \
			[filter_roundedUVMap[((filter_fracu >> (8 - FILTER_UVBITS)) << FILTER_UVBITS) + \
					((((texV) >> 8) & 0xff) >> (8 - FILTER_UVBITS))]]

#define filter_getRoundedForSpan(texU, texV) \
	filter_getScale2xQuadColors(source[(((texU) >> 16) & 0x3f) | (((texV) >> 10) & 0xfc0)], \
...
#define filter_getFilteredForColumn32(depthmap, texV, nextRowTexV) \
	(VID_PAL32(depthmap(nextsource[(nextRowTexV) >> FRACBITS]), \
			...
			VID_PAL32(depthmap(source[(nextRowTexV) >> FRACBITS]), \
					((0xffff - filter_fracu) * ((texV)&0xffff)) >> (32 - VID_COLORWEIGHTBITS)) + \
			...
			VID_PAL32(depthmap(nextsource[(texV) >> FRACBITS]), \
					(filter_fracu * (0xffff - ((texV)&0xffff))) >> (32 - VID_COLORWEIGHTBITS)))
...
#define filter_getFilteredForSpan32(depthmap, texU, texV) \
	(VID_PAL32(depthmap(source[((((texU) + FRACUNIT) >> 16) & 0x3f) | \
			 ...
			 (unsigned int)(((texU)&0xffff) * ((texV)&0xffff)) >> (32 - VID_COLORWEIGHTBITS)) + \
			VID_PAL32(depthmap(source[(((texU) >> 16) & 0x3f) | \
							  ((((texV) + FRACUNIT) >> 10) & 0xfc0)]), \
					(unsigned int)((0xffff - ((texU)&0xffff)) * ((texV)&0xffff)) >> \
							(32 - VID_COLORWEIGHTBITS)) + \
			VID_PAL32(depthmap(source[(((texU) >> 16) & 0x3f) | (((texV) >> 10) & 0xfc0)]), \
					(unsigned int)((0xffff - ((texU)&0xffff)) * (0xffff - ((texV)&0xffff))) >> \
							(32 - VID_COLORWEIGHTBITS)) + \
			VID_PAL32(depthmap(source[((((texU) + FRACUNIT) >> 16) & 0x3f) | \
							  (((texV) >> 10) & 0xfc0)]), \
...
#define filter_getFilteredForSpan16(depthmap, texU, texV) \
	(VID_PAL16(depthmap(source[((((texU) + FRACUNIT) >> 16) & 0x3f) | \
			...
			VID_PAL16(depthmap(source[(((texU) >> 16) & 0x3f) | \
					...
					(unsigned int)((0xffff - ((texU)&0xffff)) * ((texV)&0xffff)) >> \
							(32 - VID_COLORWEIGHTBITS)) + \
			VID_PAL16(depthmap(source[(((texU) >> 16) & 0x3f) | (((texV) >> 10) & 0xfc0)]), \
					(unsigned int)((0xffff - ((texU)&0xffff)) * (0xffff - ((texV)&0xffff))) >> \
							(32 - VID_COLORWEIGHTBITS)) + \
			VID_PAL16(depthmap(source[((((texU) + FRACUNIT) >> 16) & 0x3f) | \
							  (((texV) >> 10) & 0xfc0)]), \
...
#define filter_getFilteredForSpan15(depthmap, texU, texV) \
	(VID_PAL15(depthmap(source[((((texU) + FRACUNIT) >> 16) & 0x3f) | \
			...
			VID_PAL15(depthmap(source[(((texU) >> 16) & 0x3f) | \
					...
					(unsigned int)((0xffff - ((texU)&0xffff)) * ((texV)&0xffff)) >> \
							(32 - VID_COLORWEIGHTBITS)) + \
			VID_PAL15(depthmap(source[(((texU) >> 16) & 0x3f) | (((texV) >> 10) & 0xfc0)]), \
					(unsigned int)((0xffff - ((texU)&0xffff)) * (0xffff - ((texV)&0xffff))) >> \
							(32 - VID_COLORWEIGHTBITS)) + \
			VID_PAL15(depthmap(source[((((texU) + FRACUNIT) >> 16) & 0x3f) | \
							  (((texV) >> 10) & 0xfc0)]), \
