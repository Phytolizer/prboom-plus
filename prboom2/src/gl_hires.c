...
typedef struct _DDRAW_H_DDPIXELFORMAT {
	...
	union {
		...
		unsigned long dwZBufferBitDepth;   // how many total bits/pixel in z buffer (including any
		                                   // stencil bits)
	...
	union {
		...
		unsigned long
				dwStencilBitDepth; // how many stencil bits (note:
		                           // dwZBufferBitDepth-dwStencilBitDepth is total Z-only bits)
	...
	static hires_path_t hires_paths[] = {
			{doom, GLDT_TEXTURE,
					{{"%stextures/doom/doom1/%s.%s", -1}, {"%stextures/doom/doom1/%s-ck.%s", -1},
							...
							{"%stextures/doom/%s-ck.%s", -1}, {"%stextures/%s.%s", -1},
							{"%stextures/%s-ck.%s", -1}, {NULL, 0}}},
			{doom, GLDT_FLAT,
					{{"%sflats/doom/doom1/%s.%s", -1}, {"%stextures/doom/doom1/flat-%s.%s", -1},
							{"%stextures/doom1/flat-%s.%s", -1}, {"%sflats/doom/%s.%s", -1},
							{"%stextures/doom/flat-%s.%s", -1}, {"%sflats/%s.%s", -1},
			...
			{doom2, GLDT_TEXTURE,
					{{"%stextures/doom/doom2/%s.%s", -1}, {"%stextures/doom/doom2/%s-ck.%s", -1},
							{"%stextures/doom/%s.%s", -1}, {"%stextures/doom/%s-ck.%s", -1},
							{"%stextures/%s.%s", -1}, {"%stextures/%s-ck.%s", -1}, {NULL}}},
			{doom2, GLDT_FLAT,
					{{"%sflats/doom/doom2/%s.%s", -1}, {"%stextures/doom/doom2/flat-%s.%s", -1},
							{"%sflats/doom/%s.%s", -1}, {"%stextures/doom/flat-%s.%s", -1},
							{"%sflats/%s.%s", -1}, {"%stextures/flat-%s.%s", -1}, {NULL}}},
			{doom2, GLDT_PATCH,
			...
			{pack_tnt, GLDT_PATCH,
					{{"%spatches/doom/tnt/%s.%s", -1}, {"%spatches/doom2-tnt/%s.%s", -1},
							{"%spatches/tnt/%s.%s", -1}, {"%spatches/doom/%s.%s", -1},
							{"%spatches/%s.%s", -1}, {NULL}}},
			...
			{pack_plut, GLDT_PATCH,
					{{"%spatches/doom/plut/%s.%s", -1}, {"%spatches/doom2-plut/%s.%s", -1},
							{"%spatches/plutonia/%s.%s", -1}, {"%spatches/doom/%s.%s", -1},
							{"%spatches/%s.%s", -1}, {NULL}}},

			{hacx, GLDT_TEXTURE,
					{{"%stextures/hacx/%s.%s", -1}, {"%stextures/hacx/%s-ck.%s", -1},
							{"%stextures/%s.%s", -1}, {"%stextures/%s-ck.%s", -1}, {NULL}}},
			{hacx, GLDT_FLAT,
					{{"%sflats/hacx/%s.%s", -1}, {"%stextures/hacx/flat-%s.%s", -1},
							{"%sflats/%s.%s", -1}, {"%stextures/flat-%s.%s", -1}, {NULL}}},
			{hacx, GLDT_PATCH, {{"%spatches/hacx/%s.%s", -1}, {"%spatches/%s.%s", -1}, {NULL}}},

			{chex, GLDT_TEXTURE,
					{{"%stextures/chex/%s.%s", -1}, {"%stextures/chex/%s-ck.%s", -1},
							{"%stextures/%s.%s", -1}, {"%stextures/%s-ck.%s", -1}, {NULL}}},
			{chex, GLDT_FLAT,
					{{"%sflats/chex/%s.%s", -1}, {"%stextures/chex/flat-%s.%s", -1},
							{"%sflats/%s.%s", -1}, {"%stextures/flat-%s.%s", -1}, {NULL}}},
	...
	if (GLEXT_glCompressedTexImage2DARB) {
		...
		if (ddsimage) {
			...
			if (tex_width == ddsimage->width && tex_height == ddsimage->height) {
				...
				/* load the mipmaps */
				for (i = 0;
						i < (numMipmaps ? numMipmaps : 1) && (ddsimage->width || ddsimage->height);
						i++) {
					if (ddsimage->width == 0)
						ddsimage->width = 1;
...
int gld_PrecacheGUIPatches(void) {
	static const char* staticpatches[] = {"INTERPIC", // "TITLEPIC",
			...
			"M_EPISOD", "M_GDHIGH", "M_GDLOW", "M_HURT", "M_JKILL", "M_LGTTL", "M_LOADG",
			"M_LSCNTR", "M_LSLEFT", "M_LSRGHT", "M_MESSG", "M_MSENS", "M_MSGOFF", "M_MSGON",
			"M_MUSVOL", "M_NEWG", "M_NGAME", "M_NMARE", "M_OPTION", "M_OPTTTL", "M_PAUSE",
			"M_QUITG", "M_RDTHIS", "M_ROUGH", "M_SAVEG", "M_SCRNSZ", "M_SFXVOL", "M_SGTTL",
			"M_SKILL", "M_SKULL1", "M_SKULL2", "M_SVOL", "M_THERML", "M_THERMM", "M_THERMO",
			"M_THERMR", "M_ULTRA", "M_EPI4",

			// prboom's M_*
			"M_ACCEL", "M_AUTO", "M_BUTT1", "M_BUTT2", "M_CHAT", "M_COLORS", "M_COMPAT", "M_COMPAT",
			"M_ENEM", "M_GENERL", "M_HORSEN", "M_KEYBND", "M_KEYBND", "M_LOKSEN", "M_MESS",
			"M_PALNO", "M_PALSEL", "M_SETUP", "M_STAT", "M_STAT", "M_VBOX", "M_VERSEN", "M_WEAP",
