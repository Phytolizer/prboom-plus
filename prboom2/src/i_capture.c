...
typedef struct { // information on a running pipe
...
static int threadstdoutproc(void* data) { // simple thread proc dumps stdout
	// not terribly fast
	int c;
...
static int threadstderrproc(void* data) { // simple thread proc dumps stderr
	// not terribly fast
	int c;
